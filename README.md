...
**Public leaderboard: 0.80243** (top scores on this permanent competition hover around 0.81 to 0.82).
...
3. **Models**: regularized gradient boosting (LightGBM) vs. HistGradientBoosting baseline, stratified 5-fold CV
...
| LightGBM (600 trees, lr 0.03) | 0.8103 ± 0.0053 | n/a |

The ~0.9pt gap between CV and LB is expected sampling noise on ~4300 test rows, with no sign of leakage or overfitting.
